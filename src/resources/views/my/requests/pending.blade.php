@extends('layouts.app')
@section('title','申請一覧（承認待ち）')

@section('content')
<h1 class="section-title">申請一覧（承認待ち）</h1>
...
<div style="overflow:auto;">
    <table class="att-table" style="width:100%; border-collapse:collapse;">
        <thead>
            <tr>
                <th style="text-align:left; padding:8px; border-bottom:1px solid #ddd;">申請日時</th>
                <th style="text-align:left; padding:8px; border-bottom:1px solid #ddd;">対象日</th>
                <th style="text-align:left; padding:8px; border-bottom:1px solid #ddd;">出勤 → 退勤（申請）</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="padding:8px; border-bottom:1px solid #eee;">
                    {{ $changes['clock_in_at'] ?? '-' }} → {{ $changes['clock_out_at'] ?? '-' }}
                </td>
